      ...
      items: [
        {
          title: "Custom Suits",
          description:
            "Tailored suits crafted to perfection, reflecting your unique style and personality.",
        },
        {
          title: "Dress Making",
          description:
            "Elegant dresses designed and created for your special occasions and everyday elegance.",
        },
        {
          title: "Alterations",
          description:
            "Expert alterations ensuring your garments fit flawlessly and enhance your appearance.",
        },
        {
          title: "Bespoke Design",
          description:
            "Custom designs bringing your vision to life with premium fabrics and expert craftsmanship.",
        },
      ],
    },
    contact: {
      ...
      items: [
        {
          ...
          description:
            "Täydellisesti räätälöidyt puvut, jotka heijastavat ainutlaatuista tyyliäsi ja persoonallisuuttasi.",
        },
        {
          title: "Mekonvalmistus",
          description:
            "Tyylikkäät mekot suunniteltu ja luotu erityisiin tilaisuuksiin ja arkiseen eleganssin.",
        },
        {
          title: "Korjaukset",
          description:
            "Asiantunteva muokkaus varmistaa vaatteiden täydellisen istuvuuden ja ulkonäön.",
        },
        {
          title: "Yksilöllinen Suunnittelu",
          description:
            "Räätälöidyt suunnitelmat tuovat visiosi eloon premium-kankailla ja ammattitaidolla.",
        },
      ],
    },
    contact: {
